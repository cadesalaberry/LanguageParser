...
public class LanguageTester {
	...
	public static void main (String[] args) {
		...
		System.out.println("1 true, " + LanguageParser.parse(splitter));
		
		splitter = new StringSplitter("foo = 23");
		System.out.println("2 false, " + LanguageParser.parse(splitter));
		
		splitter = new StringSplitter("true");
		System.out.println("3 false, " + LanguageParser.parse(splitter));
		
		splitter = new StringSplitter("if true then a=2 else false end");
		System.out.println("4 false, " + LanguageParser.parse(splitter));
		
		splitter = new StringSplitter("if true a=2 else false end");
		System.out.println("5 false, " + LanguageParser.parse(splitter));
		
		splitter = new StringSplitter("if true then a=2 else a=3 end");
		System.out.println("6 true, " + LanguageParser.parse(splitter));
		...
		System.out.println("7 true, " + LanguageParser.parse(splitter));
		
		splitter = new StringSplitter("if true then else end");
		System.out.println("8 false, " + LanguageParser.parse(splitter));
		
		splitter = new StringSplitter("if true then a=2 else if true then a=3 else a=4 end a=5 end");
		System.out.println("9 false, " + LanguageParser.parse(splitter));
